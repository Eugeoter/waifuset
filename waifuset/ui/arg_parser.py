...
def parse_args():
    ...
    parser.add_argument('--wd3_model_path', type=str, default=None, help='WaifuTaggerV3 model path / WaifuTaggerV3 模型路径')
    parser.add_argument('--wd3_label_path', type=str, default=None, help='WaifuTaggerV3 label path / WaifuTaggerV3 标签路径')
    parser.add_argument('--waifu_scorer_model_path', type=str, default=None, help='WaifuScorer model path / WaifuScorer 模型路径')

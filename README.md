...
![alt text](help/2a.png)

单击左侧画廊中的图像即选中数据，选中数据后，其他面板将显示该数据的详细信息，并允许对其进行操作。

![alt text](help/2b.png)

##### 画廊

画廊显示所选数据集子集。

![alt text](help/2h.png)
...
![alt text](help/2i-1.png)

其下方显示所选数据的其他信息。

![alt text](help/2i-2.png)
...
![alt text](help/2c.png)

##### 元数据

元数据窗格显示所选数据的实时元数据。

![alt text](help/2f.png)

##### 生成信息

生成信息窗格显示当前选中数据的生成信息（如果有）。

![alt text](help/2g-1.png)
![alt text](help/2g-2.png)
![alt text](help/2g-3.png)

##### 按钮

![alt text](help/2d.png)
...
![alt text](help/3b.png)
![alt text](help/3c.png)

##### 标签排序

标签排序面板提供了对标签进行排序的操作。标签排序的优先级顺序可在 `配置` 面板编辑、保存和加载。

![alt text](help/3d-1.png)

##### 一般去重

一般去重功能去除标注中完全重复的 tag。

![alt text](help/3d-2.png)

##### 语义去重

![alt text](help/3d-3.png)
